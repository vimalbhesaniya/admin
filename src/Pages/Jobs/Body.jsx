...
const Body = ({ onClose, style, hidden }) => {
    ...
    const { data: jobs } = api.useGetRequest({
      PATH: `FetchCompanyJobs/${companyid}`,
      enabled: true,
      initialData: [],
      key: ["company-jobs", companyid],//aaya
    });
                ...
                jobs?.map((e) => (
                  <>
                      ...
                      <tr>
                        <th>
                          <div class="d-flex align-items-center">
                            <div class="">
                              <p class="fw-bold fs-3">{e.Title}</p>
                              <p class="text-text-black-50">{e.Position}</p>
                              <p class="text-muted">
                                Posted On{" "}
                                {
                                  moment(
                    ...
                    <thead className="hand table-info ">
                      <tr className="" onClick={() => handleHide(e._id, e)}>
                        <th>
                          <b>More details</b>
                        </th>
