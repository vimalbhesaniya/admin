          ...
          <div className={css.TableContainer}>
            <table class="table table-responsive-md  align-middle mb-0 ">
              <thead class="bg-light">
                <tr className="w-25">
                  <th className="w-25 fs-5 fw-bold">
                    {data?.length}{" "}
                    {data?.length >= 1 ? " Connection " : " Connections "}Found
                  </th>
                </tr>
                <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <p class="fw-normal mb-1 text-nowrap ">
                            {e.location && e?.location[0]?.city},
                            {e.location && e?.location[0]?.state}
                          </p>
                        </td>
                        <td>{e.profession}</td>
                        <td className="">
